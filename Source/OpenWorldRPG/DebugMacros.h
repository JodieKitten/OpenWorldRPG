...
// creating a macro - like a variable but can use whole code to define one thing we want to do
//below uses DRAW_SPHERE(Location) to draw a debug sphere without having to write out the whole code
...
//use backslash \ to include multiple definitions in one 
